...
var Field = function () {
  function Field(validator) {
    ...
    this.defaultValue = this.initialValue = this.config.default === undefined || this.config.default === null ? null : clone(this.config.default);
...
var Form = function () {
  ...
  _createClass(Form, [{
    ...
    key: '_validate',
    value: function _validate(skipAttachError) {
      var _this7 = this;
      ...
      try {
        status = this.fieldNames.reduce(function (acc, field) {
          var validity = void 0;
          if (skipAttachError) {
            validity = _this7[field].isValid();
          } else {
            validity = _this7[field].validate();
          }
